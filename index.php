                    ...
                    <form action="" method="GET">
                        <div class="form-row mb-3">
                            ...
                            <div class="col mt-4 d-flex gap-5 text-start">
                                ...
                                <input type="number" class="form-control" name="lengthPassword" 
                                id="lengthPassword" min="1" max="16" placeholder="Inserisci un numero da 1 a 16" value="<?php echo ($_GET['lengthPassword'])  ?>" >
                            </div>
                            <div class="col mt-4 d-flex gap-5 text-start">
                            ...
                            <div class="col d-flex justify-content-center gap-5">
                                ...
                                <button type="submit" class="btn btn-outline-secondary mt-4">Reset</button>
